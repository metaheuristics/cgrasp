...
double CECShiftedSchwefel::getGap(){
	return (bestValue - minValue);
}

bool CECShiftedSchwefel::isNearOptimum(double fBest){
...
double CECShiftedSchwefel::calc(double *x){
	cont++;  
	long double z;	
...
double CECShiftedSchwefel::calc2(ap::real_1d_array x){
	return -1.0;
}
