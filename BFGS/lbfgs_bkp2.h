...
class LBFGS{
	...
	private:
		...
		double dotproduct(const int& n, double *dx, int sx, 
					double *dy, int sy);
		void lincomb(const int& n, const double& da, double *dx,
     				int sx, double *dy, int sy);
		void mcstep(double& stx, double& fx, double& dx, double& sty, double& fy,
					double& dy, double& stp, const double& fp, const double& dp,
     				bool& brackt, const double& stmin, const double& stmax, int& info);
		void newiteration(double *x, double f, double *g);
		void mcsrch(const int& n, double *x, double& f, double *g,
     				const double *s, int sstart, double& stp, const double& ftol,
     				const double& xtol, const int& maxfev, int& info, int& nfev,
     				double *wa, const double& gtol, const double& stpmin, const double& stpmax);
	...
	public:
		...
		void minimize(const int& n, const int& m, double *x, const double& epsg,
     			const double& epsf, const double& epsx, const int& maxits, int& info);
